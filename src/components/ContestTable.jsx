...
const ContestTable = () => {
    ...
    document.title = "ChemGenie | All contests"
    useEffect(() => {
        setSpin(true)
        let arr = [];
        db
    ...
    return <>
        <div className="container table-item">
            ...
            {isSpin ? null : <>
                <NavLink exact className="btn btn-primary float-right" to="/contest/add">Add</NavLink>
                ...
                <div className="text-nowrap table-responsive">
                    <table className="table text-center table-hover table-bordered">
                        ...
                        <tbody>
                            {contests.map((question, i) => <tr key={i}><td>{question.title}</td>
